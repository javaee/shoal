...
public class SimplePutGetRemoveTest implements CallBack {
    ...
    private DataStore<String, Object> ds = null;
    ...
    private static final Logger myLogger = java.util.logging.Logger.getLogger("SimplePutGetRemoveTest");
    ...
    public static void main(String[] args) {
        ...
        SimplePutGetRemoveTest.setupLogHandler();
        try {
        ...
        SimplePutGetRemoveTest spgrt = new SimplePutGetRemoveTest();
        spgrt.execute();
        System.out.println("================================================================");
...
//        myLogger.FINE("Is initial host="+System.getProperty("IS_INITIAL_HOST"));
    ...
    public class DoTest extends Thread implements CallBack {
        ...
        public DoTest(DataStore<String, Object> ds, GroupManagementService gms) {
            this.ds = ds;
            this.gms = gms;
        ...
        private void ObjectsTest() {
            ...
            if (ds != null) {
              ...
              /*  while (true) {
                ...
                SimplePutGetRemoveTest.sleep(2);
