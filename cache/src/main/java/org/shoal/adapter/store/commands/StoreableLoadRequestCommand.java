...
public class StoreableLoadRequestCommand<K, V extends Storeable>
    ...
    private Long minimumRequiredVersion;
    ...
    protected void writeCommandPayload(ReplicationOutputStream ros)
        ...
        ros.writeLong(minimumRequiredVersion == null ? Long.MIN_VALUE : minimumRequiredVersion);
    ...
    public void execute(String initiator) {
        ...
        try {
            ...
            if (!originatingInstance.equals(dsc.getInstanceName())) {
                LoadResponseCommand<K, V> rsp = new LoadResponseCommand<K, V>(key, result, tokenId);
