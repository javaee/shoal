...
public class MessageFilter extends BaseFilter {
    ...
    private final Attribute<MessageImpl> preparsedMessageAttr =
            Grizzly.DEFAULT_ATTRIBUTE_BUILDER.createAttribute(
            MessageFilter.class + ".preparsedMessageAttr",
            new NullaryFunction<MessageImpl>() {

                @Override
                public MessageImpl evaluate() {
    ...
    public NextAction handleRead(final FilterChainContext ctx) throws IOException {
        ...
        final MessageImpl message = preparsedMessageAttr.get(connection);
        message.
