...
public class ViewWindowProxy implements ViewWindow {
    final ViewWindow vw;

    ViewWindowProxy(ViewWindow vw) {
        this.vw = vw;
    }

    public boolean isCoordinator() {
        return vw.isCoordinator();
    }

    public List getPreviousView() {
        return vw.getPreviousView();
    }

    public List getCurrentView() {
        return vw.getCurrentView();
    }

    public List<String> getCurrentCoreMembers() {
        return vw.getCurrentCoreMembers();
    }

    public List<String> getAllCurrentMembers() {
        return vw.getAllCurrentMembers();
    }

    public List<String> getCurrentCoreMembersWithStartTimes() {
        return vw.getCurrentCoreMembersWithStartTimes();
    }

    public List<String> getAllCurrentMembersWithStartTimes() {
        return vw.getAllCurrentMembersWithStartTimes();
    }
}
